...
import HeroParticles from "@/components/molecules/hero/hero-particles";
import HeroActions from "@/components/molecules/hero/hero-actions";
import HeroStats from "@/components/molecules/hero/hero-stats";
import HeroBadge from "@/components/atoms/hero/hero-badge";
				...
				>
					...
					>
						{[
							...
							<HeroBadge key={t}>{t}</HeroBadge>
						))}
					</motion.div>

					<div className="mt-7">
						<HeroActions onPrimaryCTA={open} />
					</div>
